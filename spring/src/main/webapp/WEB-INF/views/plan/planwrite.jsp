...
<div class="planlist" style="margin-top: 100px;">
	...
	<div><input type="checkbox" value="tofamily" class="tofamily"> <label for="tofamily">가족과 함께</label>
	 	 <input type="checkbox" value="solo" class="solo">   		<label for="solo">혼자 여행</label>
	 	 <input type="checkbox" value="package" class="package"> 	<label for="package">패키지여행</label> 
