...
//JSP 화면에 하단부분 페이지 표시를 할때 필요한 정보.
	...
	public String toString() {
		return "PlanPage [perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow=" + endRow
				+ ", planTitle=" + planTitle + ", planCate=" + planCate + ", addr1=" + addr1 + ", addr2=" + addr2
				+ ", memberid=" + memberid + ", planNo=" + planNo + ", perGroupPageNum=" + perGroupPageNum
				+ ", startPage=" + startPage + ", endPage=" + endPage + ", totalPage=" + totalPage + ", totalRow="
				+ totalRow + ", pageNo=" + pageNo + ", key=" + key + ", word=" + word + ", period=" + period
				+ ", accepter=" + accepter + "]";
	}
